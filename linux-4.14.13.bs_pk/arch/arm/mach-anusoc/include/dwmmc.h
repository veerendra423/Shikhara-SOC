...
#define DWMCI_CTRL		0x000	/*Control Register*/
#define	DWMCI_PWREN		0x004	/*Power Enable Register*/
#define DWMCI_CLKDIV		0x008	/*Clock Divider Register*/
...
/* CLKENA register */
#define DWMCI_CLKEN_ENABLE      (1 << 1 | 1<<0 | 1<< 2)
#define DWMCI_CLKEN_LOW_PWR     (1 << 16)

/* Card-type registe */
#define DWMCI_CTYPE_1BIT        0
#define DWMCI_CTYPE_4BIT        (1 << 0 | 1<<1)
#define DWMCI_CTYPE_8BIT        (1 << 16| 1<<17)
