...
extern int lcd_line_length, lcd_line_length2, lcd_line_length3;
 ...
 */
extern void *lcd_base3;		/* Start of framebuffer memory 3*/ 
extern void *lcd_base2;		/* Start of framebuffer memory 2*/
...
typedef struct vidinfo {
	...
	u_char  vl_freq;        /* Frequency (Refresh rate) */

	u_char  vl_hfp;	        /* Horizontal Front Porch (Right Margin) */
	u_char  vl_hbp;	     	/* Horizontal Back Porch (Left Margine) */

	u_char  vl_vfp; 		/* Vertical Front Porch  (Lower Margin) */
	u_char  vl_vbp;	     	/* Vertical Back Port (Upper Margin)*/

	u_char  vl_hsync_len;	/* Horizontal Sync pulse length*/
	u_char  vl_vsync_len;	/* Vertical Sync Pulse lenght*/        
	
	u_char  vl_bpix;        /* Bits per pixel, 0 = 1, 1 = 2, 2 = 4, 3 = 8, 4 = 16 */
	u_char	endianess;	/* Little Endian - 0, Big Endian - 1 */
		
	u_long  pixclock;	/* Pixel clock */
        void    *priv;       	/* Pointer to driver-specific data */

} vidinfo_t;

extern vidinfo_t *panel_info1, *panel_info2, *panel_info3;
...
/*Function to call mipi-dsi initilization routine*/
extern void mipi_init (void *lcdbase2, vidinfo_t *vid);
extern void hdmi_init(void *lcdbase3, vidinfo_t *vid);
...
# define CONSOLE_ROWS		((panel_info.vl_row-BMP_LOGO_HEIGHT) \
					/ VIDEO_FONT_HEIGHT)
#else
# define CONSOLE_ROWS           ((panel_info1->vl_row-BMP_LOGO_HEIGHT) \
                                        / VIDEO_FONT_HEIGHT)
#endif


#elif defined(CONFIG_LCD_LOGO) && defined(CONFIG_LCD_INFO_BELOW_LOGO)
#ifdef CONFIG_SHIKHARA
# define CONSOLE_ROWS		(panel_info1->vl_row / VIDEO_FONT_HEIGHT)
#else
...
#ifdef CONFIG_SHIKHARA
#define CONSOLE_COLS		(panel_info1->vl_col / VIDEO_FONT_WIDTH)
#else
